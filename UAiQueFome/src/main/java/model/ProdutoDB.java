...
public class ProdutoDB {
    ...
    public static void main(String[] args) {
        ...
        cadastra(new Produto(1,"res","nome",12,1.2,-1));
    }

    private static File abreArquivoProdutos() {
        if (System.getProperty("os.name").toLowerCase().contains("win")) {
            //File arquivo = new File("caminho win");
            return new File("dados\\produtos.txt");
        } else {
    ...
    public static void cadastra(Produto produto) {
        ...
        String info = String.valueOf(produto.getCodigo()) + ";" + produto.getRestaurante() + ";" + produto.getNome() + ";" + String.valueOf(produto.getPreco()) + ";" + String.valueOf(produto.getQuantidade()) + ";" + String.valueOf(produto.getPrecoPromocao()) + ";";
    ...
    public static void alterarNome(Produto produto, String nome) {
